(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function n(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(s){if(s.ep)return;s.ep=!0;const o=n(s);fetch(s.href,o)}})();const I=(e,t,n="exp")=>({start:e,end:t,curve:n}),R={click:{name:"click",duration:.12,layers:[{type:"triangle",freq:1800,attack:.003,decay:.06,gain:.65,offset:0,filter:{type:"highpass",cutoff:900}},{type:"noise",freq:1200,attack:.002,decay:.03,gain:.2,offset:0,filter:{type:"highpass",cutoff:1500}}]},confirm:{name:"confirm",duration:.24,layers:[{type:"sine",freq:I(640,960,"exp"),attack:.005,decay:.14,gain:.52,offset:0,filter:null},{type:"triangle",freq:1280,attack:.004,decay:.11,gain:.22,offset:.02,filter:{type:"lowpass",cutoff:5200}}]},error:{name:"error",duration:.36,layers:[{type:"saw",freq:I(520,180,"linear"),attack:.004,decay:.2,gain:.62,offset:0,filter:{type:"lowpass",cutoff:2900}},{type:"square",freq:160,attack:.006,decay:.24,gain:.35,offset:.04,filter:{type:"highpass",cutoff:80}}]},notify:{name:"notify",duration:.42,layers:[{type:"sine",freq:I(480,740,"exp"),attack:.007,decay:.18,gain:.46,offset:0,filter:null},{type:"triangle",freq:I(740,990,"linear"),attack:.004,decay:.16,gain:.31,offset:.1,filter:{type:"lowpass",cutoff:6e3}}]}},ne=["sine","square","saw","triangle","noise"],ae=["linear","exp"],oe=["lowpass","highpass"],w=(e,t)=>e+Math.random()*(t-e),U=e=>e[Math.floor(Math.random()*e.length)],se=()=>{if(Math.random()<.45){const a=w(120,2200);return Math.round(a)}const e=w(100,1800),t=w(.4,2.5),n=Math.max(40,e*t);return{start:Math.round(e),end:Math.round(n),curve:U(ae)}},re=()=>Math.random()<.45?null:{type:U(oe),cutoff:Math.round(w(120,9e3))},le=()=>({type:U(ne),freq:se(),attack:Number(w(.002,.04).toFixed(3)),decay:Number(w(.04,.35).toFixed(3)),gain:Number(w(.15,.9).toFixed(2)),offset:Number(w(0,.14).toFixed(3)),filter:re()}),ie=()=>{const e=1+Math.floor(Math.random()*3),t=Array.from({length:e},le),n=Math.max(...t.map(a=>a.offset+a.attack+a.decay),.18);return{name:`rand-${Date.now().toString().slice(-4)}`,duration:Number(Math.max(.1,Math.min(1.2,n+w(.02,.18))).toFixed(3)),layers:t}},W=e=>JSON.parse(JSON.stringify(e)),x=44100,N=.002,ce=10**(-20/20),$=(e,t,n)=>Math.min(n,Math.max(t,e)),de=(e,t)=>{if(e==="sine")return Math.sin(t);if(e==="square")return Math.sin(t)>=0?1:-1;if(e==="saw"){const n=t/(Math.PI*2);return 2*(n-Math.floor(n+.5))}if(e==="triangle"){const n=t/(Math.PI*2);return 2*Math.abs(2*(n-Math.floor(n+.5)))-1}return Math.random()*2-1},O=e=>.5-.5*Math.cos(Math.PI*$(e,0,1)),ue=e=>.5+.5*Math.cos(Math.PI*$(e,0,1)),pe=(e,t,n)=>{if(e<0)return 0;const a=Math.max(N,t),s=Math.max(N,n);return e<=a?O(e/a):e<=a+s?ue((e-a)/s):0},fe=(e,t,n)=>{if(typeof e=="number")return Math.max(1,e);const a=e.curve==="exp"?"exp":"linear",s=$(t/Math.max(n,1e-6),0,1);return a==="linear"||e.start<=0||e.end<=0?Math.max(1,e.start+(e.end-e.start)*s):Math.max(1,e.start*(e.end/e.start)**s)},D=(e,t,n)=>{if(!t)return e;const a=new Float32Array(e.length),s=$(t.cutoff||1e3,20,n*.45),o=1/n,l=1/(2*Math.PI*s);if(t.type==="lowpass"){const p=o/(l+o);let y=0;for(let f=0;f<e.length;f+=1)y=y+p*(e[f]-y),a[f]=y;return a}const d=l/(l+o);let c=0,u=0;for(let p=0;p<e.length;p+=1){const y=e[p];c=d*(c+y-u),u=y,a[p]=c}return a},ye=(e,t,n)=>{const a=new Float32Array(t),s=Math.max(N*2,e.attack+e.decay),o=Math.max(0,Math.floor(e.offset*n));let l=0;for(let u=o;u<t;u+=1){const p=(u-o)/n,y=pe(p,e.attack,e.decay);if(y<=1e-8)continue;const f=fe(e.freq,p,s);l+=2*Math.PI*f/n;const M=de(e.type,l);a[u]=M*y}const d=D(a,e.filter,n),c=Number.isFinite(e.gain)?e.gain:.5;for(let u=0;u<d.length;u+=1)d[u]*=c;return d},me=(e,t)=>{let n=D(e,{type:"highpass",cutoff:20},t);n=D(n,{type:"lowpass",cutoff:1e4},t);let a=0;for(let l=0;l<n.length;l+=1)a+=n[l]*n[l];const s=Math.sqrt(a/Math.max(1,n.length));if(s>1e-9){const l=ce/s;for(let d=0;d<n.length;d+=1)n[d]*=l}for(let l=0;l<n.length;l+=1)n[l]=.95*Math.tanh(n[l]/.95);const o=Math.max(1,Math.floor(N*t));for(let l=0;l<o&&l<n.length;l+=1){const d=l/o;n[l]*=O(d),n[n.length-1-l]*=O(d)}return n},ve=(e,t=x)=>{const n=Math.max(1,Math.floor(e.duration*t)),a=new Float32Array(n);for(const s of e.layers){const o=ye(s,n,t);for(let l=0;l<n;l+=1)a[l]+=o[l]}return me(a,t)},ge=(e,t=x)=>{const n=t*2,a=e.length*2,s=new ArrayBuffer(44+a),o=new DataView(s),l=(c,u)=>{for(let p=0;p<u.length;p+=1)o.setUint8(c+p,u.charCodeAt(p))};l(0,"RIFF"),o.setUint32(4,36+a,!0),l(8,"WAVE"),l(12,"fmt "),o.setUint32(16,16,!0),o.setUint16(20,1,!0),o.setUint16(22,1,!0),o.setUint32(24,t,!0),o.setUint32(28,n,!0),o.setUint16(32,2,!0),o.setUint16(34,16,!0),l(36,"data"),o.setUint32(40,a,!0);let d=44;for(let c=0;c<e.length;c+=1){const u=$(e[c],-1,1),p=u<0?u*32768:u*32767;o.setInt16(d,p,!0),d+=2}return new Blob([s],{type:"audio/wav"})},q="click",_="1.0.0",V="ux-sfx-custom-presets-v1",T=["en","de","fr","it","es"],he=["sine","square","saw","triangle","noise"],be=["lowpass","highpass"],h=e=>JSON.parse(JSON.stringify(e)),P=()=>`sfx-${Math.random().toString(36).slice(2,6)}`,A=e=>`builtin:${e}`,G=e=>`custom:${e}`,we=()=>{try{const e=localStorage.getItem(V);if(!e)return{};const t=JSON.parse(e);return t&&typeof t=="object"?t:{}}catch{return{}}},Me=()=>{const e=window.location.pathname.split("/").filter(Boolean).map(t=>t.toLowerCase()).find(t=>T.includes(t));return T.includes(e)?e:null},Se=()=>{var t;const e=(t=new URLSearchParams(window.location.search).get("lang"))==null?void 0:t.toLowerCase();return T.includes(e)?e:null},xe=()=>{const e=(navigator.language||"en").slice(0,2).toLowerCase();return T.includes(e)?e:"en"},Ee=()=>Me()||Se()||xe(),Y=e=>{localStorage.setItem(V,JSON.stringify(e))},X=(e,t=null)=>{const n=h(e),a=typeof n.createdAt=="string"&&n.createdAt||t&&typeof t.createdAt=="string"&&t.createdAt||new Date().toISOString();return{...n,name:typeof n.name=="string"&&n.name.trim()?n.name:P(),duration:Number.isFinite(n.duration)?n.duration:.2,layers:Array.isArray(n.layers)?n.layers:[],createdAt:a,version:_}},r={spec:X(W(R[q])),selectedPreset:A(q),customPresets:we(),lang:Ee(),previewMode:"wave",activeLayerDot:0,rendered:null,audioContext:null,sourceNode:null,isPlaying:!1},Ce=document.querySelector("#app");document.documentElement.lang=r.lang;Ce.innerHTML=`
  <main class="shell">
